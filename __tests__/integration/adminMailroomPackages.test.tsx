...
const mockPackages = [
  {
    mailbox_item_id: "pkg-1",
    mailbox_item_name: "Box A",
    mailroom_registration_id: "reg-1",
    location_locker_id: "locker-1",
    mailbox_item_type: "Parcel",
    mailbox_item_status: "STORED",
    mailbox_item_notes: null,
    mailbox_item_photo: "photo-data",
    mailbox_item_created_at: new Date().toISOString(),
    registration: {
      mailroom_registration_id: "reg-1",
      full_name: "Alice Smith",
      users_email: "alice@example.com",
      mailroom_registration_code: "MR001",
      mobile_number: "09171234567",
    },
    locker: {
      location_locker_id: "locker-1",
      location_locker_code: "L001",
      is_available: false,
    },
  },
  {
    mailbox_item_id: "pkg-2",
    mailbox_item_name: "Document B",
    mailroom_registration_id: "reg-2",
    location_locker_id: null,
    mailbox_item_type: "Document",
    mailbox_item_status: "REQUEST_TO_SCAN",
    mailbox_item_notes: null,
    mailbox_item_photo: null,
    mailbox_item_created_at: new Date().toISOString(),
    registration: {
      mailroom_registration_id: "reg-2",
      full_name: "Bob Jones",
      users_email: "bob@example.com",
      mailroom_registration_code: "MR002",
      mobile_number: "09171234568",
    },
    locker: null,
  },
  {
    mailbox_item_id: "pkg-3",
    mailbox_item_name: "Package C",
    mailroom_registration_id: "reg-3",
    location_locker_id: null,
    mailbox_item_type: "Parcel",
    mailbox_item_status: "REQUEST_TO_RELEASE",
    mailbox_item_notes: null,
    mailbox_item_photo: null,
    mailbox_item_created_at: new Date().toISOString(),
    registration: {
      ...
      users_email: "charlie@example.com",
      mailroom_registration_code: "MR003",
...
const mockLockers = [
  ...
  {
    location_locker_id: "locker-2",
    location_locker_code: "L002",
    is_available: true,
  },
];
  ...
  global.fetch = jest.fn(
    async (input: RequestInfo | URL, init?: RequestInit) => {
      ...
      if (
        ...
        const updated = {
          ...(mockPackages.find((p) => p.mailbox_item_id === idMatch) ?? {}),
          ...parsed,
        };
        const index = mockPackages.findIndex(
          (p) => p.mailbox_item_id === idMatch,
        );
        if (index >= 0) {
...
describe("AdminPackages (admin/packages)", () => {
  ...
  describe("Package Actions", () => {
    ...
    it("disposes a package (REQUEST_TO_DISPOSE)", async () => {
      ...
      mockPackages.push({
        mailbox_item_id: "pkg-4",
        mailbox_item_name: "Dispose Me",
        mailroom_registration_id: "reg-1",
        location_locker_id: null,
        mailbox_item_type: "Parcel",
        mailbox_item_status: "REQUEST_TO_DISPOSE",
        mailbox_item_notes: null,
        mailbox_item_photo: null,
        mailbox_item_created_at: new Date().toISOString(),
        registration: {
