...
CREATE TYPE activity_entity_type AS ENUM ('MAIL_ACTION_REQUEST', 'USER_KYC', 'PAYMENT_TRANSACTION', 'SUBSCRIPTION', 'MAILBOX_ITEM', 'MAILROOM_REGISTRATION', 'USER_ADDRESS', 'REWARDS_CLAIM', 'REFERRAL', 'NOTIFICATION', 'MAILROOM_FILE', 'MAILROOM_ASSIGNED_LOCKER', 'USER', 'ROLE');

-- Activity Action
CREATE TYPE activity_action AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'VIEW', 'SUBMIT', 'APPROVE', 'REJECT', 'PROCESS', 'COMPLETE', 'CANCEL', 'VERIFY', 'PAY', 'REFUND', 'LOGIN', 'LOGOUT', 'REGISTER', 'CLAIM', 'RELEASE', 'DISPOSE', 'SCAN', 'STORE', 'PURCHASE', 'PASSWORD_CHANGE', 'RESET_REQUEST', 'RESTORE');
