...
-- Activity Action
CREATE TYPE activity_action AS ENUM ('STORE', 'UPDATE', 'DELETE', 'VIEW', 'SUBMIT', 'APPROVE', 'REJECT', 'PROCESS', 'COMPLETE', 'CANCEL', 'VERIFY', 'PAY', 'REFUND', 'LOGIN', 'LOGOUT', 'REGISTER', 'CLAIM', 'RELEASE', 'DISPOSE', 'SCAN', 'PURCHASE');
